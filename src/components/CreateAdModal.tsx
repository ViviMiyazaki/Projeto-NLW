          ...
          <Dialog.Title className='text-3xl font-black'>Publique um anúncio</Dialog.Title>
                ...
                <form onSubmit={handleCreateAd} className='mt-8 flex flex-col gap-4'>
                  ...
                  <div className='flex gap-6'>
                    <div className='flex flex-col gap-2'>
                      ...
                      >
                        ...
                        value="2"
                        title="Terça"
                        className={`w-8 h-8 roundedbg-zinc-900 ${weekDays.includes('2') ? 'bg-violet-600' : 'bg-zinc-900'}`}
                        >T</ToggleGroup.Item>
                        <ToggleGroup.Item
                        value="3" 
                        title="Quarta"
                  ...
                  <footer className='mt-4 flex justify-end gap-4'>
                    <Dialog.Close 
                    className='bg-zinc-600 px-5 h-12 rounded-md font-semibold hover:bg-zinc-700'
                    >
                      Cancelar
                    </Dialog.Close>
                    <button 
                    type="submit"
                    className='bg-violet-700 px-5 h-12 rounded-md font-semibold flex items-center gap-3 hover:bg-violet-800'>
